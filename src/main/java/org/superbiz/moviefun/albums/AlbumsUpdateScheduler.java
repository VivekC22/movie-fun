...
public class AlbumsUpdateScheduler {
    ...
    private boolean startAlbumSchedulerTask() {
        ...
        try {
            logger.info("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC");
            jdbcTemplate.update("CREATE TABLE album_scheduler_task (started_at TIMESTAMP NULL DEFAULT NULL);");
            jdbcTemplate.update("INSERT INTO album_scheduler_task (started_at) VALUES (NULL);");
        } catch (Exception e) {
            logger.info("ERRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR");
            e.printStackTrace();
